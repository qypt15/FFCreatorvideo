...
class FFVideoa extends FFImage {
  ...
  //   // 调整背景声音大小
  //   const volumeChange = 0.5; // 音量变化的百分比，例如0.5表示减小50％
  //   const durationChange = 5; // 持续时间的变化（以秒为单位）
  //   inputVideo.volume(volumeChange).duration(durationChange).outputOptions('-c:v copy');
